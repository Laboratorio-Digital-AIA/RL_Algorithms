...
#HPR_toy___bmilplib_bmilplib_110_10
#follower_toy___bmilplib_bmilplib_110_10
#HPR_toy_17
#follower_toy_17
m = Models.HPR_toy_2()
follower = Models.follower_toy_2
print("Models loaded")
ins = '2'
save = False
#save = False
...
f = follower({i.VarName:0 for i in m.getVars()})
...
#print(output)
	...
	if save_gap_plot:
		...
		plt.title('Bounds behavior for instance '+str(ins)+'. Final local gap: '+str(round(gap_bilevel*100,2))+'%')
		plt.xlabel('Time (s)')
